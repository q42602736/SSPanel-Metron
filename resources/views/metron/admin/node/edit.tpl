                                    ...
                                    <div class="card-inner">
                                        ...
                                        <div id="dedicated_sale_fields" {if $node->sale_type!=1}style="display:none"{/if}>
                                            ...
                                            <div class="form-group form-group-label">
                                                ...
                                                <input class="form-control maxwidth-edit" id="dedicated_node_speedlimit" type="number" min="0" step="0.01" value="{$node->node_speedlimit|default:0}" name="dedicated_node_speedlimit">
