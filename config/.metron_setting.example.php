...
$_MT['enable_reg_ip_limit']         = true;       // 是否启用同一IP注册数量限制
$_MT['reg_ip_limit']                = 5;          // 同一IP允许注册的最大账号数量，设置为0表示不限制

# ┌──────────────────────────────────────────────────────────────────────────────────────────────────────────┐
# │                                              客服系统 设置                                                │
# └──────────────────────────────────────────────────────────────────────────────────────────────────────────┘
$_MT['enable_cust']                 = 'none';                   // 使用哪种客服系统  none: 关闭 目前支持: crisp | chatra | chatwoot
